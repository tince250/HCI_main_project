...
insert into Restaurants (Name, Image, AddressId, Latitude, Longitude) values ("Sushi bar", "sushi.jpg", 3, 44.821500, 20.463789);
insert into Attractions (Name, Image, AddressId, Latitude, Longitude) values ("Fortress", "fortress.jpg", 4, 44.827242, 20.457272);
insert into Attractions (Name, Image, AddressId, Latitude, Longitude) values ("Belgrade zoo", "zoo.jpg", 5, 44.810401, 20.437032);
insert into Accommodations (Name, Image, AddressId, Latitude, Longitude, Type) values ("Hotel Moscow", "moscow.jpg", 6, 44.792210, 20.462648, 0);
insert into Accommodations (Name, Image, AddressId, Latitude, Longitude, Type) values ("Hayat", "hayat.jpg", 7, 44.817952, 20.472783, 0);
